...
public partial class ScarletLibrary : Node
{
    ...
    public override void _Ready()
    {
        ...
        Floor1 = MapPrebuild.Generate(100, 100, MapPrebuilder.GetMapPrebuild("Scarlet4dCorner"), new Vector2I(50, 50),
            10, "ScarletWall", MapPrebuilder.MapPrebuildDeck);
        Floor1.Entrance = new Vector2I(55, 55);
