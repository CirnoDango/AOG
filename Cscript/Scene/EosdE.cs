...
public partial class EosdE : Node, IMapNode
{
    ...
    public async void Load()
    {
        ...
        G.I.DialogBox.Show();
        G.I.DialogBox.ShowDialog([
    new("Objective:", LoadPortrait("null"),
    "Enter the Scarlet Devil Mansion and defeat Remilia.")
]); await Click();
    ...
    public async void Victory()
    {
        ...
        G.I.DialogBox.ShowDialog([
    new("", LoadPortrait("null"),
    "Congratulations! You have resolved the Scarlet Mist Incident and achieved victory! This concludes the content of version 0.5. Please look forward to the next update.")
]); await Click();
        G.I.Fsm.ChangeState(Fsm.UpdateState);
        G.I.DialogBox.Hide();
    }
